...
/**
 * Servlet implementation class ReturnsList_Admin
 */
@WebServlet("/returnsList_Admin.do")
public class ReturnsList_Admin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("view/page/returns/returns_list_admin.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (member == null) {
	    	...
	    	List<ReturnsVO> list = service.selectAllReturns_admin();
